...
This barchart shows among the LGBTQ population that contracted AIDS, more of them contracted AIDS while taking the vaccine than the LGBTQ population that contracted AIDS while taking the placebo so there is a vaccine effectiveness.
...
The P-Value is 0 which is less than 0.5 so we reject the null hypothesis and conclude that we have enough evidence to prove that the vaccine makes LGBTQ population more susceptible to contacting AIDS.
